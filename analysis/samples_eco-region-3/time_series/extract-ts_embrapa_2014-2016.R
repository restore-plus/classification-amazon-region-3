...
# Function to extract time series from the "Amostras_AMZ_2020_pastagens" dataset
...
# Function to extract time series from the "samples_sentinel_aml_2021-2022_embrapa" dataset
...
# Function to extract time series from the "samples_landsat_amazon-rainforest_2020" dataset
...
# Processing years
regularization_years <- c(2016, 2015, 2014) # c(2022, 2021, 2020)
